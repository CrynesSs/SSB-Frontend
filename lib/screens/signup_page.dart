...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _pickPublicKeyFile() async {
    final result = await FilePicker.platform.pickFiles(type: FileType.custom, allowedExtensions: ['txt', 'pem', 'key']);
  ...
  Future<void> _signup() async {
    ...
    if (username.isEmpty || password.isEmpty || passphrase.isEmpty || _publicKeyBytes == null) {
      setState(() {
    ...
    try {
      final response = await http.post(
        Uri.parse("http://localhost:5000/accounts/create_account"), // change if needed
